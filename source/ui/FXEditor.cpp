...
FXEditor::FXEditor(PMProcessor &proc_) : proc(proc_)
{
...
void FXEditor::valueUpdated(gin::Parameter *param) // we'll use this to set any other box with the
                                                   // same effect selected to "None"
{
...
{
    if (proc.fxOrderParams.fxa1->getUserValueInt() == effect)
    { // abstract this...
    ...
    if (proc.fxOrderParams.fxa2->getUserValueInt() == effect)
    { // abstract this...
    ...
    if (proc.fxOrderParams.fxa3->getUserValueInt() == effect)
    { // abstract this...
    ...
    if (proc.fxOrderParams.fxa4->getUserValueInt() == effect)
    { // abstract this...
    ...
    if (proc.fxOrderParams.fxb1->getUserValueInt() == effect)
    { // abstract this...
    ...
    if (proc.fxOrderParams.fxb2->getUserValueInt() == effect)
    { // abstract this...
    ...
    if (proc.fxOrderParams.fxb3->getUserValueInt() == effect)
    { // abstract this...
    ...
    if (proc.fxOrderParams.fxb4->getUserValueInt() == effect)
    { // abstract this...
