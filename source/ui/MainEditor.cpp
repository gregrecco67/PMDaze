...
{
    box->setBounds(static_cast<int>(x * 56.f), static_cast<int>(y * 70.f + 23.f * heds), static_cast<int>(w * 56.f),
                   static_cast<int>(h * 70.f + 23.f));
}
...
void MainEditor::resized()
{
    ...
    setGrid(&lfo1, 10, 4, 2, 3, 2);
    setGrid(&lfo2, 13, 4, 2, 3, 2);
