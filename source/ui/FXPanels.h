...
class FXBox : public gin::ParamBox
{
  public:
    FXBox(const juce::String &name,
          PMProcessor &proc_) // gin::Parameter::Ptr box_)
...
{
  public:
    FXModBox(const juce::String &name, PMProcessor &proc_) : gin::ParamBox(name), proc(proc_)
    {
        setName("mod");
...
{
  public:
    MatrixBox(const juce::String &name, PMProcessor &proc_) : gin::ParamBox(name), proc(proc_)
    {
        setName("mtx");
