...
class APModulationDepthSlider : public juce::Slider
{
  ...
  private:
    void paint(juce::Graphics &g) override
    {
        ...
        {
            g.setColour(findColour(gin::PluginLookAndFeel::accentColourId).withAlpha(0.9f));
...
class APKnob : public gin::ParamComponent, public juce::DragAndDropTarget, private juce::Timer, private gin::ModMatrix::Listener
{
  public:
    ...
    void setDisplayName(const juce::String &n) { name.setText(n, juce::dontSendNotification); }
...
{
  public:
    ParameterSelector(PMProcessor &p_, gin::ModSrcId src) : proc(p_), macroSrc(src)
    {
